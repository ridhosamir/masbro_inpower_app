...
class _TechnicianDashboardResourceState
  ...
  Widget _buildRatingSection() {
    // Widget baru untuk mengambil dan menampilkan data rating spesifik untuk Resource App.
    if (currentUser == null) return const SizedBox.shrink();

    return FutureBuilder<Map<String, dynamic>>(
      // Memanggil metode yang secara spesifik menghitung rating dari 'technician_ratings_resource'.
      // Metode _calculateAverageRatingFromCollection sudah melakukan hal ini.
      future:
          _firestoreService.getTechnicianRatingForResourceApp(currentUser!.uid),
      builder: (context, snapshot) {
        // Menangani state saat data dimuat
